...
function buttonAnimation(buttonColour){
    $("#"+buttonColour+">img").attr("src", "./assets/"+buttonColour+"-on.png");
    $("#"+buttonColour).addClass("pressed");
    setTimeout(function(){
        $("#"+buttonColour+">img").attr("src", "./assets/"+buttonColour+"-off.png");
...
// detection for screen touch to start the game
...
function gameOver(){
    ...
    $("h1").text("Game Over. Restarting Soon...");
}
